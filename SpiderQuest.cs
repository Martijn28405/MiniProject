namespace MiniProject
{
    public class SpiderQuest
    {
        ...
        public void startQuest()
        {
            ...
            if (userChoice == "1")
            {
                System.Console.WriteLine("You chose to ignore the adventurers advice!\nYou almost immediately see a horde of spiders, they look stronger than usual.");
            ...
            else if (userChoice == "2")
            {
                ...
                System.Console.WriteLine("Suddenly a horde of spiders appear infront of you. They look stronger than usual.");
        ...
        public void battleBridge()
        {
            ...
            Console.WriteLine("After killing the spiders, you decide to return to the Bridge.\n There you see one of the guards from earlier.");
